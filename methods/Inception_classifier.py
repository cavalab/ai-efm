# adapted from https://github.com/hfawaz/InceptionTime/blob/master/classifiers/inception.py
# resnet model
import keras
import numpy as np
import time
...
class Inception(Model):
    ...
    def build_model(self, input_shape, nb_classes=2, output_bias=None):
...
def make_model(input_shape, output_bias=None):
    ...
    return Inception(input_shape).build_model(input_shape, output_bias=output_bias)
